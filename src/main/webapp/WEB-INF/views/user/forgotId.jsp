					...
					<div class="row justify-content-center">
						<div class="col-lg-5">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								...
								<div class="card-body">
									<div class="small mb-3 text-muted">이메일을 입력하시오</div>
									<form action="${pageContext.request.contextPath }/user/forgotIdOk" method="POST" onsubmit="return formCheck();">
										...
										<div
											...
											<input type="submit" class="btn btn-primary" value="Id찾기" />
										</div>
