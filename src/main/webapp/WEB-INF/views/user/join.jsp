					...
					<div class="row justify-content-center">
						<div class="col-lg-7">
							<div class="card shadow-lg border-0 rounded-lg mt-5">
								...
								<div class="card-body">
									<form action="<c:url value="joinOk"/>" method="post"
										class="form-horizontal" onsubmit="return formCheck();">
										<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
										<div class="form-floating mb-3">
											<input type="text" class="form-control" id="userid"
											 	name="userid" placeholder="사용자 아이디 입력" required/> <label for="userid">아이디</label>
											 <span style="margin-left: 5px; font-size: 13px; text-align: center;">아이디는 영문 대소문자와 숫자 4~12자리 입력해야합니다!</span>
										<div id="idMessage"
										...
										<div class="form-floating mb-3">
											<input type="text" class="form-control" id="email"
												name="email" placeholder="이메일 주소 입력" required/> <label for="email">이메일 주소</label>
										</div>
										<div class="row mb-3">
											<div class="col-md-6">
