            ...
            <div class="row justify-content-center">
                <div class="col-lg-12">
                    ...
                    <article>
                        ...
                        <header class="mb-4">
                            <!-- Post title-->
                            <h1 class="fw-bolder mb-1">${gvo.good_title}</h1>
                            <!-- Post meta content-->
                            <div class="text-muted fst-italic mb-2"><fmt:formatDate value="${gvo.good_regdate}" type="date" dateStyle="short"/></div>
                            <!-- Post categories -->
                        </header>
                        <!-- Post content-->
                        <section class="mb-5" style="font-size: 15pt">
                        	<pre><c:out value="${gvo.good_content }" /></pre>
                        </section>
                    </article>
                </div>
            </div>
