...
<c:import url="/WEB-INF/views/include/top_menu.jsp" />
	<table id="main_content">
		...
		<tr>
			<th>아이디</th>
			<td> 
				<c:out value="${fv.userid }"></c:out>
			</td>
			<td> 
				<fmt:formatDate value="${fv.free_board_regdate }" pattern="yyyy년 MM월 dd일(E) hh:mm:ss"/>
			</td>
		</tr>
		<tr>
			<th>제목</th>
			<td colspan="3"> 
				<c:out value="${fv.free_board_title }"></c:out>
			</td>
		</tr>
		<tr>
			<th valign="top">내용</th>
			<td colspan="3"> 
				<div id="content">${fv.free_board_content }</div>
			</td>
		</tr>
		<tr>
			<th valign="top">자료</th>
